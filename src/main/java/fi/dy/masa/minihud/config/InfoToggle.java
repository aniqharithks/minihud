...
public enum InfoToggle implements IConfigInteger, IHotkeyTogglable
{
    ...
    LOOKING_AT_CHUNK        ("infoLookingAtChunk",          false, 26, "", "Show which chunk the player is currently looking at"),
    ...
    SNEAKING                ("infoSneaking",                false, 40, "", "Show the \"Sneaking\" info line if the player is sneaking"),
